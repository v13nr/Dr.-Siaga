...
class Blog extends CI_Controller {
	...
	public function index($page=0){
		...
		// load model
		$this->load->model('BlogCustomerModel');
		...
		$blog = $this->BlogCustomerModel->getlist(20,$page,$filter);
		...
		// prepare data
		$data['jmlh_data']	= count($blog);
		$data['jmlh_item']	= $this->config->item('jmlh_item');
		$data['action'] 	= site_url().'/blog/add';
		$data['results'] 	= $blog;
		$data['file'] 		= 'list';
