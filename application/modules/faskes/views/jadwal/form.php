			...
			<form name="formcrud" method="POST" action="<?=$action;?>" class="form-horizontal" role="form">
				<div class="row">
					...
					<div class="col-md-8">
						<div class="form-group">
							<label>Nama Dokter <span style="color:red">*</span></label>
							<input class="form-control" name="nama_dr" id="nama_dr" type="text" value="<?php echo $results[0]['gelar_depan']." ".$results[0]['gelar']." ".$results[0]['nama_dokter']." ".$results[0]['gelar_belakang']." ".$results[0]['title'];?>" required>
						</div>
					</div>
				<div class="col-md-12">
