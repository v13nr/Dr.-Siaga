				...
				<div class="row">
					<div class="col-md-8">
						<div class="form-group">
							...
							<select name="tipe_faskes" id="tipe_faskes" class="form-control" disabled>
								<option value="">Pilih Tipe Faskes</option>
								<option value="DR" <?php if($faskes[0]['tipe']=='DR'){ echo "selected"; } ?> >Dokter Praktek Pribadi</option>
								<option value="KL" <?php if($faskes[0]['tipe']=='KL'){ echo "selected"; } ?> >Klinik</option>
								<option value="PS" <?php if($faskes[0]['tipe']=='PS'){ echo "selected"; } ?> >Puskesmas</option>
								<option value="RSUD" <?php if($faskes[0]['tipe']=='RSUD'){ echo "selected"; } ?> >Rumah Sakit Daerah</option>
								<option value="RSIA" <?php if($faskes[0]['tipe']=='RSIA'){ echo "selected"; } ?> >Rumah Sakit Ibu Anak</option>
								<option value="RS" <?php if($faskes[0]['tipe']=='RS'){ echo "selected"; } ?> >Rumah Sakit Umum</option>
							</select>
						</div>
					</div>
					<div class="col-md-8">
