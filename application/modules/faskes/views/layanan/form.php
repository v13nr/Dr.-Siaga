		...
		<div class="box_general padding_bottom">
			...
			<form name="formcrud" method="POST" action="<?=$action;?>" class="form-horizontal" role="form">
				<div class="row">
					...
					<div class="col-md-8">
						<div class="form-group">
							...
							<input class="form-control" name="nama_layanan" id="nama_layanan" type="text" value="<?php echo $results[0]['nama_layanan'];?>" required>
						</div>
					</div>
					<div class="col-md-8">
						<div class="form-group">
							<label>Harga <span style="color:red">*</span></label>
							<input class="form-control" name="harga_min" id="harga_min" type="text" value="<?php echo $results[0]['harga_min'];?>" required>
						</div>
					</div>
				</div>
				<div class="row" style="padding-top:20px">
					...
					<a href="<?=base_url('faskes/layanan');?>" class="btn btn-default btn-inversed btn-small" style="width:100px;height:38px;padding:8px">Cancel</a>
					</div>
				</div>
				<input type="hidden" name="button" value="Save">
				<input type="hidden" name="layanan_id" id="layanan_id" value="<?=$results[0]['layanan_id'];?>">
			</form>
		</div>
		<!-- /box_general-->
