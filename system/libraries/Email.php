...
class CI_Email {
	...
	var	$smtp_host		= "nano.webmail.co.id";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "info@doktersiaga.com";		// SMTP Username
	var	$smtp_pass		= "unicorn2020";		// SMTP Password
